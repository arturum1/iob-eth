...
\section{CSR Detailed Description for Sofware}
\label{sec:csrs_details}

This section presents a detailed description of the Control and Status Registers, described in section~\ref{sec:csrs}, useful for writing the software drivers of this IP core.

\begin{xltabular}{\textwidth}{|l|l|X|}
  
  \hline
  \rowcolor{iob-green}
  {\bf Bit \#} & {\bf R/W} & {\bf Description} \\ \hline \hline
  \endfirsthead
  \hline
...
\begin{xltabular}{\textwidth}{|l|l|X|}
  ...
  6      & RW & RXC - Receive Control Frame
              ...
              must be set to 1 in order to get the RXC bit set. \\* \nobreakhline
  5      & RW & TXC - Transmit Control Frame

              This bit indicates that a control frame was transmitted. It is
              cleared by writting 1 to it. Bit RXFLOW (CTRLMODER register)
              must be set to 1 in order to get the TXC bit set. \\* \nobreakhline
  \rowcolor{iob-blue}
  4      & RW & BUSY - Busy
...
\begin{xltabular}{\textwidth}{|l|l|X|}
  ...
  6-0      & RW & IPGR1 - Non Back to Back Inter Packet Gap 1
              ...
              is 0xC. It must be within the range [0,IPGR2]. \\
\end{xltabular}
\label{csr_details:ipgr1}
...
\begin{xltabular}{\textwidth}{|l|l|X|}
  ...
  6-0      & RW & IPGR2 - Non Back to Back Inter Packet Gap 2
              ...
              \mu s$ IPG (100 Mbps) or $9.6 \mu s$ (10 Mbps).\\
\end{xltabular}
\label{csr_details:ipgr2}
...
\begin{xltabular}{\textwidth}{|l|l|X|}
  ...
  31-16   & RW  & MINFL - Minimum Frame Length 
              ...
              (see the PAD bit description in the MODER register). \\* \nobreakhline
  \rowcolor{iob-blue}
  15-0   & RW  & MAXFL - Maximum Frame Length 
              ...
              description in the MODER).\\
\end{xltabular}
\label{csr_details:packetlen}
...
\begin{xltabular}{\textwidth}{|l|l|X|}
  ...
  2  & RW  & TXFLOW - Transmit Flow Control
              ...
              enables the TXC bit in the INT\_SOURCE register.\\* \nobreakhline
...
\begin{xltabular}{\textwidth}{|l|l|X|}
  ...
  0   & 0 &   When a PAUSE control frame is received, nothing happens. The
              control frame is not stored to the memory.\\* \nobreakhline
  \rowcolor{iob-blue}
  ...
  1   & 0 &   When a PAUSE control frame is received, it is stored to the
              ...
              interrupt is not set and pause timer is not updated.\\* \nobreakhline
  \rowcolor{iob-blue}
...
\end{xltabular}
\label{csr_details:passall_rxflow}
...
\begin{xltabular}{\textwidth}{|l|l|X|}
  ...
  1      & R & BUSY
              ...
              1 = The MII is bysy (operation in progress). \\* \nobreakhline
  \rowcolor{iob-blue}
  0      & R & LINKFAIL
