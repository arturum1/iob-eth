...
################################################################################
set_bus_skew -from [get_clocks {clk}] -to [get_clocks {rx_clk}] [expr $clk_period * 0.9]
set_bus_skew -from [get_clocks {rx_clk}] -to [get_clocks {clk}] [expr $clk_period * 0.9]
set_bus_skew -from [get_clocks {clk}] -to [get_clocks {tx_clk}] [expr $clk_period * 0.9]
set_bus_skew -from [get_clocks {tx_clk}] -to [get_clocks {clk}] [expr $clk_period * 0.9]
